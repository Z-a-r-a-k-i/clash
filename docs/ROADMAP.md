...
- **M2 — Network play by invitation.** Lift the resolver to a server. Server technology and wire protocol picked at this point — candidate paths (Go + protobuf, headless Godot/C#, Nakama, etc.) tracked in ADR 0006. Direct invitation links; no matchmaker yet. First time two humans can actually play.
