...
- [`07b1-renderer-and-camera.md`](./07b1-renderer-and-camera.md) — `ready`. Renderer + camera + attack visualization. *See the map.*
...
- [ ] All five sub-PRs land. *(07a `done`; 07b1 `ready`; 07b2/3/4 `stub`)*
