...
- [`07b3-perspective-and-fog.md`](./07b3-perspective-and-fog.md) — `doing`. Per-player perspective + fog of war (ADR-0016). *Swap perspectives.*
...
- [ ] All five sub-PRs land. *(07a `done`; 07b1 `done`; 07b2 `done`; 07b3 `doing`; 07b4 `stub`)*
