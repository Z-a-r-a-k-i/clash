...
| Dev play mode + scenario tooling | [07-dev-play-mode/](07-dev-play-mode/) | compound — 07a `done`; 07b1 `doing`; 07b2/3/4 `stub` |
...
- [ ] All nine child nodes are `done`. *(seven done; 07-dev-play-mode/ in progress: 07a done, 07b1 doing, 07b2-07b4 remaining)*
