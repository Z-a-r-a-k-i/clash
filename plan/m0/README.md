...
| Dev play mode + scenario tooling | [07-dev-play-mode/](07-dev-play-mode/) | compound - 07a `done`; 07b1 `done`; 07b2 `done`; 07b3 `done`; 07b4 `done`; 07b5 `done`; 07b6 `doing`; 07b7 `stub` |
...
- [ ] All eight child nodes are `done`. *(07-dev-play-mode/ in progress: playtest loop active; tick-step debugger deferred unless playtests make it necessary)*
