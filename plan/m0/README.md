...
| Dev play mode + scenario tooling | [07-dev-play-mode/](07-dev-play-mode/) | compound — 07a `done`; 07b1 `done`; 07b2 `done`; 07b3 `doing`; 07b4 `stub` |
...
- [ ] All nine child nodes are `done`. *(07-dev-play-mode/ in progress: 07a, 07b1, and 07b2 done; 07b3 doing; 07b4 remaining)*
